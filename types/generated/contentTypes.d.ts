...
export interface ApiArtistArtist extends Schema.CollectionType {
  ...
  attributes: {
    ...
    events: Attribute.Relation<
      ...
      'api::event.event'
    >;
    image_main: Attribute.Media<'images'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    image_secondary: Attribute.Media<'images'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    background_landscape: Attribute.Media<'images'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    background_portrait: Attribute.Media<'images'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    ticket_header_mobile: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ticket_header_desktop: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    homepage_header_mobile: Attribute.Text &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    homepage_header_desktop: Attribute.Text &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    ticket_text_before: Attribute.Blocks &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ticket_text_after: Attribute.Blocks &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    faq_header_mobile: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    faq_header_desktop: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiInfoBannerInfoBanner extends Schema.CollectionType {
  collectionName: 'info_banners';
  info: {
    singularName: 'info-banner';
    pluralName: 'info-banners';
